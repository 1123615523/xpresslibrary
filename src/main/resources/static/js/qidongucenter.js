...
function initMenu() {
    ...
    if (qidong.cpath + "/ucenter" == pathName || qidong.cpath + "/ucenter/" == pathName) {
        pathName = qidong.cpath + "/ucenter/index"
    }
...
function initCkEdtior(editor, height) {
    ...
    return CKEDITOR.replace(editor, {
        ...
        height: height,
        uploadUrl: qidong.cpath + '/commons/ckeditor/upload',
        imageUploadUrl: qidong.cpath + '/commons/ckeditor/upload',
        filebrowserUploadUrl: qidong.cpath + '/commons/ckeditor/upload',
        language: 'zh-cn'
