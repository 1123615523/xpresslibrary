...
$("#cd-nav-ul").append(temp);}}else{$("#cd-nav-ul").innerHTML="";$("#cd-nav-ul").append("<li><a href= 'javascript:void(0)'><span>您尚未有浏览记录</span></a></li>");}}}
